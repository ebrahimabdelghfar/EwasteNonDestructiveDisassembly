#ifndef _ROS_SERVICE_GetRAPIDSymbol_h
#define _ROS_SERVICE_GetRAPIDSymbol_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char GETRAPIDSYMBOL[] = "abb_robot_msgs/GetRAPIDSymbol";

  class GetRAPIDSymbolRequest : public ros::Msg
  {
    public:
      typedef abb_robot_msgs::RAPIDSymbolPath _path_type;
      _path_type path;

    GetRAPIDSymbolRequest():
      path()
    {
    }
    ...
    virtual const char * getType() override { return GETRAPIDSYMBOL; };
    virtual const char * getMD5() override { return "575c1566b746b035b579d998cd699eb8"; };

  };

  class GetRAPIDSymbolResponse : public ros::Msg
  {
    public:
