#ifndef _ROS_SERVICE_SetRAPIDString_h
#define _ROS_SERVICE_SetRAPIDString_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char SETRAPIDSTRING[] = "abb_robot_msgs/SetRAPIDString";

  class SetRAPIDStringRequest : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return SETRAPIDSTRING; };
    virtual const char * getMD5() override { return "c81ac0a08ec42b48b22060c8bbfc22d7"; };

  };

  class SetRAPIDStringResponse : public ros::Msg
  {
    public:
