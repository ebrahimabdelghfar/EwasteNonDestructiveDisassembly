...
namespace joint_qualification_controllers
{
  ...
  class HysteresisRun : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "joint_qualification_controllers/HysteresisRun"; };
    virtual const char * getMD5() override { return "53b5a9cc98e4aeb9e2e39c07ea2a59f5"; };
