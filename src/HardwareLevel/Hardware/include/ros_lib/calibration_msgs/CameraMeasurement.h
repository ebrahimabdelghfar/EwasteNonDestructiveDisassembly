...
namespace calibration_msgs
{
  ...
  class CameraMeasurement : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "calibration_msgs/CameraMeasurement"; };
    virtual const char * getMD5() override { return "f7a0cca96cdd8e17d1424338e086252f"; };
