...
namespace calibration_msgs
{
  ...
  class DenseLaserObjectFeatures : public ros::Msg
  {
    ...
    DenseLaserObjectFeatures():
      header(),
      dense_laser_points_length(0), st_dense_laser_points(), dense_laser_points(nullptr),
    ...
    virtual const char * getType() override { return "calibration_msgs/DenseLaserObjectFeatures"; };
    virtual const char * getMD5() override { return "b642d46e47d54e00f98a3d98b02b5cc6"; };
