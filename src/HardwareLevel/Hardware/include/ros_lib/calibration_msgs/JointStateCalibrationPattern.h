...
namespace calibration_msgs
{
  ...
  class JointStateCalibrationPattern : public ros::Msg
  {
    ...
    JointStateCalibrationPattern():
      ...
      joint_points_length(0), st_joint_points(), joint_points(nullptr)
    {
    }
    ...
    virtual const char * getType() override { return "calibration_msgs/JointStateCalibrationPattern"; };
    virtual const char * getMD5() override { return "c80e9cf8e7942eba44a6d32e3c75bf59"; };
