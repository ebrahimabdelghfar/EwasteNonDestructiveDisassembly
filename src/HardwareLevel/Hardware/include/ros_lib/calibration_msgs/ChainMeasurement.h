...
namespace calibration_msgs
{
  ...
  class ChainMeasurement : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "calibration_msgs/ChainMeasurement"; };
    virtual const char * getMD5() override { return "a57d957972fc9bc34b14f2a3cac0fbae"; };
