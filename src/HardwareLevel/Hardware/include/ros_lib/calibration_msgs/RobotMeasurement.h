...
namespace calibration_msgs
{
  ...
  class RobotMeasurement : public ros::Msg
  {
    ...
    RobotMeasurement():
      ...
      target_id(""),
      chain_id(""),
      M_cam_length(0), st_M_cam(), M_cam(nullptr),
      M_laser_length(0), st_M_laser(), M_laser(nullptr),
      M_chain_length(0), st_M_chain(), M_chain(nullptr)
    {
    }
    ...
    virtual const char * getType() override { return "calibration_msgs/RobotMeasurement"; };
    virtual const char * getMD5() override { return "fe22486c078efbf7892430dd0b99305c"; };
