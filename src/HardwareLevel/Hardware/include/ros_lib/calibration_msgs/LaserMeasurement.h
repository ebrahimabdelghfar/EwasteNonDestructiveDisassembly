...
namespace calibration_msgs
{
  ...
  class LaserMeasurement : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "calibration_msgs/LaserMeasurement"; };
    virtual const char * getMD5() override { return "7fa7e818b1234a443aa5d8e315175d17"; };
