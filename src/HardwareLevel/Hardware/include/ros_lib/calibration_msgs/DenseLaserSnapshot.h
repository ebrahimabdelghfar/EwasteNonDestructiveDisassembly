...
namespace calibration_msgs
{
  ...
  class DenseLaserSnapshot : public ros::Msg
  {
    ...
    DenseLaserSnapshot():
      ...
      scan_start_length(0), st_scan_start(), scan_start(nullptr)
    {
    }
    ...
    virtual const char * getType() override { return "calibration_msgs/DenseLaserSnapshot"; };
    virtual const char * getMD5() override { return "deb2810d3530db3484f886a81243195d"; };
