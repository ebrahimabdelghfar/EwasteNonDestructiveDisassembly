...
namespace calibration_msgs
{
  ...
  class IntervalStatus : public ros::Msg
  {
    ...
    IntervalStatus():
      ...
      yeild_rates_length(0), st_yeild_rates(), yeild_rates(nullptr)
    {
    }
    ...
    virtual const char * getType() override { return "calibration_msgs/IntervalStatus"; };
    virtual const char * getMD5() override { return "277fe87e9a44a07ab27c97b6b37d5898"; };
