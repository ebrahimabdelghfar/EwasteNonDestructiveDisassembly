...
namespace calibration_msgs
{
  ...
  class CalibrationPattern : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "calibration_msgs/CalibrationPattern"; };
    virtual const char * getMD5() override { return "5854af5462e19a169f68917c875a6238"; };
