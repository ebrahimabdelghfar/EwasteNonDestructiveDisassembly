#ifndef _ROS_moveit_task_constructor_msgs_TaskDescription_h
#define _ROS_moveit_task_constructor_msgs_TaskDescription_h
...
namespace moveit_task_constructor_msgs
{
  ...
  class TaskDescription : public ros::Msg
  {
    public:
      typedef const char* _task_id_type;
      _task_id_type task_id;
      uint32_t stages_length;
      typedef moveit_task_constructor_msgs::StageDescription _stages_type;
    ...
    virtual int deserialize(unsigned char *inbuffer) override
    {
      ...
      if(stages_lengthT > stages_length)
        this->stages = (moveit_task_constructor_msgs::StageDescription*)realloc(this->stages, stages_lengthT * sizeof(moveit_task_constructor_msgs::StageDescription));
      stages_length = stages_lengthT;
      for( uint32_t i = 0; i < stages_length; i++){
      offset += this->st_stages.deserialize(inbuffer + offset);
        memcpy( &(this->stages[i]), &(this->st_stages), sizeof(moveit_task_constructor_msgs::StageDescription));
      }
     return offset;
    }

    virtual const char * getType() override { return "moveit_task_constructor_msgs/TaskDescription"; };
    virtual const char * getMD5() override { return "54c0104c9822086952fd493bd0d4655d"; };
