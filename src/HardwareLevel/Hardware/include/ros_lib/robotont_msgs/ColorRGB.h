#ifndef _ROS_robotont_msgs_ColorRGB_h
#define _ROS_robotont_msgs_ColorRGB_h
...
namespace robotont_msgs
{
  ...
  class ColorRGB : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "robotont_msgs/ColorRGB"; };
