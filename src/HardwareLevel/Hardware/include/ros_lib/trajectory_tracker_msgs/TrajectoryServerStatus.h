#ifndef _ROS_trajectory_tracker_msgs_TrajectoryServerStatus_h
#define _ROS_trajectory_tracker_msgs_TrajectoryServerStatus_h
...
namespace trajectory_tracker_msgs
{
  ...
  class TrajectoryServerStatus : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "trajectory_tracker_msgs/TrajectoryServerStatus"; };
    virtual const char * getMD5() override { return "62ff07f086a6acc6192879b76ea83a15"; };
