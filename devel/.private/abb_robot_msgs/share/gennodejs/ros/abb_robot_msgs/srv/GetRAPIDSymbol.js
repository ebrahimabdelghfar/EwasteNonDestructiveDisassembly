...
class GetRAPIDSymbolRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetRAPIDSymbolRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetRAPIDSymbolRequest
    let len;
    let data = new GetRAPIDSymbolRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetRAPIDSymbolRequest(null);
...
class GetRAPIDSymbolResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetRAPIDSymbolResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetRAPIDSymbolResponse
    let len;
    let data = new GetRAPIDSymbolResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetRAPIDSymbolResponse(null);
...
module.exports = {
  Request: GetRAPIDSymbolRequest,
  Response: GetRAPIDSymbolResponse,
  md5sum() { return 'bde39a2871b891ab4e4dba6d1b2afbe4'; },
  datatype() { return 'abb_robot_msgs/GetRAPIDSymbol'; }
};
