...
class SetRAPIDNumRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SetRAPIDNumRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SetRAPIDNumRequest
    let len;
    let data = new SetRAPIDNumRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new SetRAPIDNumRequest(null);
...
class SetRAPIDNumResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SetRAPIDNumResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SetRAPIDNumResponse
    let len;
    let data = new SetRAPIDNumResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new SetRAPIDNumResponse(null);
...
module.exports = {
  Request: SetRAPIDNumRequest,
  Response: SetRAPIDNumResponse,
  md5sum() { return '4108cd886758eb287b6fb706804d2b63'; },
  datatype() { return 'abb_robot_msgs/SetRAPIDNum'; }
};
