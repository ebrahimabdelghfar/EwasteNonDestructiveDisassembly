...
class GetRAPIDNumRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetRAPIDNumRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetRAPIDNumRequest
    let len;
    let data = new GetRAPIDNumRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetRAPIDNumRequest(null);
...
class GetRAPIDNumResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetRAPIDNumResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetRAPIDNumResponse
    let len;
    let data = new GetRAPIDNumResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetRAPIDNumResponse(null);
...
module.exports = {
  Request: GetRAPIDNumRequest,
  Response: GetRAPIDNumResponse,
  md5sum() { return '50b6604c67513df1c689dbe2ae540bb1'; },
  datatype() { return 'abb_robot_msgs/GetRAPIDNum'; }
};
