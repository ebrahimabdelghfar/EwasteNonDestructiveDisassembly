...
class SetFileContentsRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SetFileContentsRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SetFileContentsRequest
    let len;
    let data = new SetFileContentsRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new SetFileContentsRequest(null);
...
class SetFileContentsResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SetFileContentsResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SetFileContentsResponse
    let len;
    let data = new SetFileContentsResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new SetFileContentsResponse(null);
...
module.exports = {
  Request: SetFileContentsRequest,
  Response: SetFileContentsResponse,
  md5sum() { return 'b9fd3989a30f4c529cc017e54ab4c80f'; },
  datatype() { return 'abb_robot_msgs/SetFileContents'; }
};
