...
"""autogenerated by genpy from abb_robot_msgs/GetRAPIDDnumRequest.msg. Do not edit."""
import codecs
import sys
...
class GetRAPIDDnumRequest(genpy.Message):
  _md5sum = "575c1566b746b035b579d998cd699eb8"
  _type = "abb_robot_msgs/GetRAPIDDnumRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GetRAPIDDnumRequest, self).__init__(*args, **kwds)
...
def _get_struct_I():
    ...
    return _struct_I
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from abb_robot_msgs/GetRAPIDDnumResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class GetRAPIDDnumResponse(genpy.Message):
  _md5sum = "e8223c10294ae2ec72c03c61fc136636"
  _type = "abb_robot_msgs/GetRAPIDDnumResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """
#-------------------------------------------------------------------------------
...
"""
  ...
  _slot_types = ['float64','uint16','string']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GetRAPIDDnumResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_dH().pack(_x.value, _x.result_code))
      _x = self.message
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.value, _x.result_code,) = _get_struct_dH().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
...
def _get_struct_dH():
    ...
    return _struct_dH
class GetRAPIDDnum(object):
  _type          = 'abb_robot_msgs/GetRAPIDDnum'
  _md5sum = '8bea96ce1c5c1ccf9562161041904147'
  _request_class  = GetRAPIDDnumRequest
  _response_class = GetRAPIDDnumResponse
