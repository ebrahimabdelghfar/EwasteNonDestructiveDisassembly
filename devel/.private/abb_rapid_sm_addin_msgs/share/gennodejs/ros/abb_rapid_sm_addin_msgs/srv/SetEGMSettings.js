...
class SetEGMSettingsRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SetEGMSettingsRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SetEGMSettingsRequest
    let len;
    let data = new SetEGMSettingsRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new SetEGMSettingsRequest(null);
...
class SetEGMSettingsResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SetEGMSettingsResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SetEGMSettingsResponse
    let len;
    let data = new SetEGMSettingsResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new SetEGMSettingsResponse(null);
...
module.exports = {
  ...
  Response: SetEGMSettingsResponse,
  md5sum() { return '1308f55a0badf1657b70daea7afc5401'; },
  datatype() { return 'abb_rapid_sm_addin_msgs/SetEGMSettings'; }
};
