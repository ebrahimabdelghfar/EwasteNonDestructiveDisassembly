...
"""autogenerated by genpy from abb_rapid_sm_addin_msgs/RuntimeState.msg. Do not edit."""
import codecs
import sys
...
class RuntimeState(genpy.Message):
  _md5sum = "1f803b084f80e27cb1a45c04dc77c6e7"
  _type = "abb_rapid_sm_addin_msgs/RuntimeState"
...
uint8 egm_action
"""
  __slots__ = ['header','state_machines']
  _slot_types = ['std_msgs/Header','abb_rapid_sm_addin_msgs/StateMachineState[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(RuntimeState, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.state_machines)
      buff.write(_struct_I.pack(length))
      for val1 in self.state_machines:
        _x = val1.rapid_task
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = abb_rapid_sm_addin_msgs.msg.StateMachineState()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
        ...
        if python3:
          val1.rapid_task = str[start:end].decode('utf-8', 'rosmsg')
        else:
          val1.rapid_task = str[start:end]
        _x = val1
        start = end
        end += 2
        (_x.sm_state, _x.egm_action,) = _get_struct_2B().unpack(str[start:end])
        self.state_machines.append(val1)
      return self
