...
"""autogenerated by genpy from abb_rapid_sm_addin_msgs/SetEGMSettingsRequest.msg. Do not edit."""
import codecs
import sys
...
class SetEGMSettingsRequest(genpy.Message):
  _md5sum = "081e736ac1ee21b823542360d17eb3ae"
  _type = "abb_rapid_sm_addin_msgs/SetEGMSettingsRequest"
...
"""
  __slots__ = ['task','settings']
  _slot_types = ['string','abb_rapid_sm_addin_msgs/EGMSettings']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SetEGMSettingsRequest, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_30fB12f().pack(_x.settings.activate.wobj.uframe.trans.x, _x.settings.activate.wobj.uframe.trans.y, _x.settings.activate.wobj.uframe.trans.z, _x.settings.activate.wobj.uframe.rot.q1, _x.settings.activate.wobj.uframe.rot.q2, _x.settings.activate.wobj.uframe.rot.q3, _x.settings.activate.wobj.uframe.rot.q4, _x.settings.activate.wobj.oframe.trans.x, _x.settings.activate.wobj.oframe.trans.y, _x.settings.activate.wobj.oframe.trans.z, _x.settings.activate.wobj.oframe.rot.q1, _x.settings.activate.wobj.oframe.rot.q2, _x.settings.activate.wobj.oframe.rot.q3, _x.settings.activate.wobj.oframe.rot.q4, _x.settings.activate.correction_frame.trans.x, _x.settings.activate.correction_frame.trans.y, _x.settings.activate.correction_frame.trans.z, _x.settings.activate.correction_frame.rot.q1, _x.settings.activate.correction_frame.rot.q2, _x.settings.activate.correction_frame.rot.q3, _x.settings.activate.correction_frame.rot.q4, _x.settings.activate.sensor_frame.trans.x, _x.settings.activate.sensor_frame.trans.y, _x.settings.activate.sensor_frame.trans.z, _x.settings.activate.sensor_frame.rot.q1, _x.settings.activate.sensor_frame.rot.q2, _x.settings.activate.sensor_frame.rot.q3, _x.settings.activate.sensor_frame.rot.q4, _x.settings.activate.cond_min_max, _x.settings.activate.lp_filter, _x.settings.activate.sample_rate, _x.settings.activate.max_speed_deviation, _x.settings.run.cond_time, _x.settings.run.ramp_in_time, _x.settings.run.offset.trans.x, _x.settings.run.offset.trans.y, _x.settings.run.offset.trans.z, _x.settings.run.offset.rot.q1, _x.settings.run.offset.rot.q2, _x.settings.run.offset.rot.q3, _x.settings.run.offset.rot.q4, _x.settings.run.pos_corr_gain, _x.settings.stop.ramp_out_time))
...
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from abb_rapid_sm_addin_msgs/SetEGMSettingsResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class SetEGMSettingsResponse(genpy.Message):
  _md5sum = "aab0cc4b756aaf08eb67ad6459b36b27"
  _type = "abb_rapid_sm_addin_msgs/SetEGMSettingsResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """
#-------------------------------------------------------------------------------
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SetEGMSettingsResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
...
def _get_struct_H():
    ...
    return _struct_H
class SetEGMSettings(object):
  _type          = 'abb_rapid_sm_addin_msgs/SetEGMSettings'
  _md5sum = '1308f55a0badf1657b70daea7afc5401'
  _request_class  = SetEGMSettingsRequest
  _response_class = SetEGMSettingsResponse
